...
public class Uc4 {
	...
	public static double length1 = lengthCal(x1, x2, y1, y2);
	public static double length2 = lengthCal(x3, x4, y3, y4);
	...
	public static void main(String[] args) {
		...
		sc.close();
		/*
		 * Calling method by creating Object to check equality
		 */
		Uc4 compare = new Uc4();
	 ...
	 */
	public static double lengthCal(int x1, int x2, int y1, int y2) {
